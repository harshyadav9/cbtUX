...
import { medium } from "../environment";
import {
  getCurrentTime,
...
function Copyright() {
  return (
    <Typography variant="body1" calign="center">
      {"Copyright © "}
      <Link href="https://www.unicsolutons.edu">www.unicsolutons.edu</Link>{" "}
...
export default function Login() {
  ...
  useEffect(() => {
    let examStartInterval = setInterval(() => {
      ...
      let isLoginAllowed = evaluateEnableDisableBasedOnTime(
        "2022-02-03 1:50",
        "2022-02-03 1:51",
        currentTime
      );
      ...
      // console.log("difference",currentTime.minutes  -  examStartTime.minutes);
      // if((Math.abs(currentTime.minutes  -  examStartTime.minutes) == 0) && (currentTime.hours == examStartTime.hours)){
      //  console.log("exam can start");
  ...
  return (
    <div className={`signinpage ${classes.root}`}>
      {/* header start */}
      {/* <Header/> */}
      {/*  header end */}
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Button
              type="submit"
              disabled={
                isregValid === false && ispassValid === false ? false : true
              }
              //disabled={(isLoginAllowed === true)  ? true : false}
            ...
            >
              <AccessAlarmIcon />
              <Typography variant="span">02h 23min 24sec remaining</Typography>
            </Box>
            <Button
              type="submit"
              fullWidth
